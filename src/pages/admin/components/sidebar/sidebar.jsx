...
import { FaUserCog, FaBlog, FaRuler, FaFillDrip, FaGem } from "react-icons/fa";
...
const Sidebar = () => {
  ...
  const arrayLink = [
    ...
    { icon: FaRuler, href: "/admin/sizes", title: "Quản lý Kích thước" },
    { icon: FaFillDrip, href: "/admin/colors", title: "Quản lý Màu sắc" },
    { icon: FaGem, href: "/admin/materials", title: "Quản lý Chất liệu" },
