              ...
              <table className="xl:w-full  w-[1100px]">
                <thead className="bg-[#e5e1e1] ">
                  <tr >
                    ...
                    <td className="rounded-l-[10px] p-[15px] text-[14px] font-[600] py-[10px] w-[200px]">Tên chất liệu</td>
                        ...
                        <tr>
                          <td colSpan="7">
                            <div className="flex items-center justify-center gap-[10px] py-[30px] text-[14px] text-gray-500">
                              ...
                              <span className="md:text-[16px] text-[14px]">Không tìm thấy chất liệu</span>
                            </div>
                          </td>
                        </tr>
                      )
