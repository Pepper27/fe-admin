export default function Dashboard(){
    return(
        <> 
            <div className="xl:w-[calc(100%-240px)] lg:w-[calc(100%-220px)] w-full mt-[100px] lg:ml-[240px] ml-0  flex justify-center flex-col">
                <div className="w-full grid xl:grid-cols-3 sm:grid-cols-2 grid-cols-1 gap-y-[20px] xl:gap-x-[40px] gap-x-[20px] md:px-[30px] px-[16px]">
                    <div className="bg-[white] flex items-center gap-[20px] justify-center py-[20px] rounded-[20px]">
                        <img src="/image/user.png" className="w-[70px] " />
                    ...
                    <div className="bg-[white] flex items-center gap-[20px] justify-center py-[20px] rounded-[20px]">
                        <img src="/image/order.png" className="w-[70px]" />
                        <div className="flex flex-col">
                    ...
                    <div className="bg-[white] flex items-center gap-[20px] justify-center py-[20px] rounded-[20px]">
                        <img src="/image/revenue.png" className="w-[70px]" />
                        <div className="flex flex-col">
