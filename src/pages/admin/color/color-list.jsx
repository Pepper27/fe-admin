                    ...
                    colors.length > 0 ? (
                      colors.map(item => (
                        <tr key={item._id}>
                          ...
                          <td className="p-[15px]">
                            <div className="flex">
                              <a href={`/admin/color/update/${item._id}`} className="rounded-l-[10px] text-[14px] p-[15px] bg-[white] border-y border-l border-gray-300">
                        ...
                        <tr>
                          <td colSpan="7">
                            <div className="flex items-center justify-center gap-[10px] py-[30px] text-[14px] text-gray-500">
                              ...
                              <span className="md:text-[16px] text-[14px]">Không tìm thấy màu sắc</span>
                            </div>
                          </td>
                        </tr>
                      )
...
// Delete handler placed at bottom to keep structure similar to other list files
